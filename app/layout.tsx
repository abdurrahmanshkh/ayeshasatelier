...
export const metadata: Metadata = {
  ...
  keywords: [
    "Ayesha Siddiqui Artist",
    "Ayesha Siddiqui Taloja",
    "Ayesha Siddiqui Taloja Phase 1",
    "Taloja artist",
    "Taloja Phase 1 artist",
    "custom artwork Mumbai",
    "custom artwork Taloja",
    "handmade crochet India",
    "handmade crochet Taloja",
    "custom sketches portraits",
    "personalized art",
    "handmade gifts Mumbai",
    "handmade gifts Taloja",
    "custom embroidery",
    "portrait artist Mumbai",
    "portrait artist Taloja",
    "crochet blankets custom",
    "handcrafted art India",
    "handcrafted art Taloja",
